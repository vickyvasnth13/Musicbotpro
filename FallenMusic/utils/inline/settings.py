...
def setting_markup(_):
    buttons = [
        [
            InlineKeyboardButton(text="Aᴜᴛʜ ᴜsᴇʀs", callback_data="AU"),
            InlineKeyboardButton(text="Pʟᴀʏ ᴍᴏᴅᴇ", callback_data="PM"),
        ],
        [
            InlineKeyboardButton(text="Vᴏᴛɪɴɢ ᴍᴏᴅᴇ", callback_data="VM")
        ],
        [
