...
from FallenMusic.utils.database import get_authuser_names, get_cmode
from FallenMusic.utils.decorators import (ActualAdminCB, AdminActual,
                                         language)
from FallenMusic.utils.formatters import alpha_to_int
...
async def restartbot(client, message: Message, _):
    ...
    try:
        db[message.chat.id] = []
        await Fallen.stop_stream(message.chat.id)
    except:
        pass
